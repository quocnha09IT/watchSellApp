...
public class dayDHadapter extends RecyclerView.Adapter<dayDHadapter.ItemHolder>  {

    Context context;
    ArrayList<product> arrayProduct;

    public dayDHadapter(Context context, ArrayList<product> arrayProduct) {
    ...
    @NonNull
    @Override
    public dayDHadapter.ItemHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_lv_dongho,null);
        dayDHadapter.ItemHolder itemHolder = new dayDHadapter.ItemHolder(v);
        return itemHolder;
    }


    public void onBindViewHolder(@NonNull dayDHadapter.ItemHolder holder, int position) {
        ...
        holder.setItemClickListener(new dayDHadapter.ItemClickListener() {
            @Override
            public void onClick(View view, int position, boolean isLongClick) {
                Intent intent = new Intent(dayDHadapter.this.context, detail_product.class);
    ...
    public class ItemHolder extends RecyclerView.ViewHolder  implements View.OnClickListener,View.OnLongClickListener {
        ...
        private dayDHadapter.ItemClickListener itemClickListener;
        ...
        public void setItemClickListener(dayDHadapter.ItemClickListener itemClickListener)
        {
